    ...
    <form onSubmit={handleSubmit} className="flex items-center max-w-sm mx-auto">   
      ...
      <div className="relative w-full">
        ...
        <input
          ...
          className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-cyan-800 focus:border-cyan-800 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-cyan-800 dark:focus:border-cyan-800"
          placeholder="Search City (Indonesia)"
          required
        />
      </div>
